...
def run_trial(trials):
    ...
    bounds = [[0.10, 1], [0.10, 1], [0.1, 20], [1, 20], [0.10, 1]] # [thickness liner; thickness flute; wavelength; height; thickness liner

    for problem_ind in range(2):
        print(problem_ind)

        pso = PSO(function=score, bounds=bounds, n_particles=30, n_iterations=1000, w=0.7, c1=2.05, c2=2.05,
