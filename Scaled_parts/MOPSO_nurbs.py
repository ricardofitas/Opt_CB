...
import time
import copy
import Optimization_CB_rand_nurbs as Optimization_CB_v2_prod
...
def run_trial(trials):
    ...
    class PSO:
        def __init__(self, function, bounds, w, c1, c2, n_particles, n_iterations, funcoes_objetivo, folder, problem_ind): #AQUIIIIIIIIIIIIIIII
            ...
            for i in range(n_particles):
                ...
                objectives = [obj2/obj1, obj2/obj3, obj4]
    ...
    for problem_ind in range(1):
        ...
        pso = PSO(function=score, bounds=bounds, n_particles=100, n_iterations=1000, w=0.7, c1=2.05, c2=2.05,
                  funcoes_objetivo=True,
                  folder="prob_CB_prod_rand_nurbs_v2/EPSO" + str(problem_ind) + "/EPSO_" + str(trials),
